...
namespace AMSS.Migrations
{
    ...
    [Migration("20250701055035_AddCareLogTableToDb")]
    partial class AddCareLogTableToDb
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AMSS.Entities.CareLogs.CareLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("Carelogs", "Novaris");
                });

            modelBuilder.Entity("AMSS.Entities.ChatRoomUsers.ChatRoomUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.ToTable("ChatRoomUsers", "Novaris");
                });

            modelBuilder.Entity("AMSS.Entities.ChatRooms.ChatRoom", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("AMSS.Entities.Field", b =>
                {
                    ...
                    b.Property<int>("GrazingRestDays")
                        .HasColumnType("int");

                    b.Property<string>("InternalId")
                        .HasColumnType("nvarchar(50)");

                    b.Property<string>("LightProfile")
                        .HasColumnType("nvarchar(20)");
            ...
            modelBuilder.Entity("AMSS.Entities.Messages.Message", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("AMSS.Entities.ChatRoomUsers.ChatRoomUser", b =>
                {
                    b.HasOne("AMSS.Entities.ChatRooms.ChatRoom", "ChatRoom")
            ...
            modelBuilder.Entity("AMSS.Entities.Farm", b =>
                {
                    b.HasOne("AMSS.Entities.Locations.Location", "Location")
                        .WithMany()
